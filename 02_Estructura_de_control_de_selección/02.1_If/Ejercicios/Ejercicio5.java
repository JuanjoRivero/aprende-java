...
NOTA: && sirve como and, y te ayudará a realizar en una condicion 2 condiciones (EJEMPLO: puntuacion >= 80 && puntuacion <= 89)
*/
public class Ejercicio5 {
    public static void main(String[] args) {
        int puntuacion = 85; 
        // Completa aquí para asignar una calificación basada en la puntuación
    }
}
