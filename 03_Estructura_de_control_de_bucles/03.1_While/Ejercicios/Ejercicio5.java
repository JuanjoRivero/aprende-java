...
public class Ejercicio5 {
    public static void main(String[] args) {
        ...
        // Completa aquí para solicitar un número del 1 al 7 al usuario
        // Utiliza switch para imprimir el nombre del día correspondiente
        // El bucle debe continuar hasta que se ingrese un número fuera del rango
    }
}
